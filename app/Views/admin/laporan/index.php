...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted small mb-0">Rekapitulasi seluruh aktivitas penjualan produk.</p>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="bg-light">
                    <tr>
                        <th class="ps-4 py-3 border-0 text-uppercase small fw-bold text-muted">Waktu Transaksi</th>
                        <th class="py-3 border-0 text-uppercase small fw-bold text-muted">Produk</th>
                        ...
                        <?php foreach ($penjualan as $item): ?>
                            <tr>
                                <td class="ps-4 py-3">
                                    ...
                                    <div class="extra-small text-muted"><?= date('H:i', strtotime($item['tanggal'])) ?> WIB</div>
                                </td>
                                <td class="py-3">
                ...
                <tfoot class="bg-light">
                    <tr>
                        <th colspan="3" class="ps-4 py-3 border-0 text-uppercase small fw-bold text-dark text-end">Total Pendapatan Seluruhnya</th>
